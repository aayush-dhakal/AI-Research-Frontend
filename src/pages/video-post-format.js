          ...
          <div className="col-12">
            <div className="post-gallery-thumb mb-70">
              <div className="video position-relative">
                ...
                <img
                  src="/assets/images/video-post-format/video-post-format-thumb.jpg"
                  alt=""
                />
              </div>
            </div>
              ...
              <div className="row justify-content-center g-4">
                <div className="col-lg-4 col-md-4 col-sm-6">
                  <div className="video position-relative">
                    ...
                    <img
                      src="/assets/images/video-post-format/video-post-format-video-img1.jpg"
                      alt=""
                    />
                  </div>
                </div>
                <div className="col-lg-4 col-md-4 col-sm-6">
                  <div className="video position-relative">
                    <div className="video-play sibling-2">
                      <a data-fancybox="popup-youtube">
                        <i className="bx bx-play" />
                      </a>
                    </div>
                    <img
                      src="/assets/images/video-post-format/video-post-format-video-img2.jpg"
                      alt=""
                    />
                  </div>
                </div>
                <div className="col-lg-4 col-md-4 col-sm-6">
                  <div className="video position-relative">
                    ...
                    <img
                      src="/assets/images/video-post-format/video-post-format-video-img3.jpg"
                      alt=""
                    />
                  </div>
                </div>
