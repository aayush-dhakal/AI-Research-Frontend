              ...
              <div className="col-lg-3 p-lg-0">
                <div className="author-sidebar">
                  <div className="author-sidebar-img">
                    <img
                      src="/assets/images/post-format/author-sidebar-img2.jpg"
                      alt=""
                    />
                  </div>
              ...
              <div className="col-lg-9 p-lg-0">
                <div className="post-thumb">
                  ...
                  <div className="post-thumb-img">
                    <img
                      src="/assets/images/post-format/post-thumb-img.jpg"
                      alt=""
                    />
                ...
                <div className="row justify-content-center">
                  <div className="col-lg-10">
                    <p className="first-para">
                      NSuspendisse bibendum efficitur orci, a pretium erat
                      mattis nec. Vestibulum ante ypsumi primis inaetahsjanl
                      faucibus orci luctus etenjot ultrices posuere cubilia
                      curae; Curabitur.
                    </p>
                    <p className="second-para">
                      {" "}
                      urna Aenean onewaryzo eleifend vitae tellus a facilisis.
                      Nunc posuere at augue eget porta. Inei odio tellus,
                      dignissim fermentumara purus nec, consequat dapibus
                      metus.Vivamus urna worlda mauris, faucibus at egestas
                      quis, fermentum egetonav neque. Duis pharetra lectus nec
                      risusonl pellentesque, vitae aliquet nisi dapibus. Sed
                      volutpat mi velit, ateng maximus est eleifend accui Fusce
                      porttitor ex arcu. Phasellus viverra lorem a nibh placerat
                      tincidunt.bolgotai Aliquam andit rutrum elementum urna,
                      vel fringilla tellus varius ut. Morbi non velit odio.
                    </p>
                    <blockquote className="text-center">
                      <p className="blockquote-text">
                        "I work with Alguneb Johnl on many projects, he always
                        toldagona exceeds my expectations with his quality work
                        and fastestopa tope service, very smooth and simple
                        communication."
                      </p>
                    ...
                    <div className="col-lg-12">
                      ...
                      <p>
                        urna Aenean onewaryzo eleifend vitae tellus a facilisis.
                        Nunc posuere at augue eget portat Inei odio tellus,
                        dignissim fermentumara purus nec, consequat dapibus
                        metus.Vivamus one urna worlda mauris, faucibus at
                        egestas quis, fermentum egetonav neque.
                      </p>
                    </div>
                  </div>
                </div>
