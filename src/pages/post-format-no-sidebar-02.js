            ...
            <div className="row justify-content-center g-4">
              <div className="col-lg-8">
                <p className="first-para">
                  ...
                  nec. Vestibulum ante ypsumi primis inaetahsjanl faucibus orci
                  luctus etenjot ultrices posuere cubilia curae; Curabitur.
                </p>
                <p className="second-para">
                  ...
                  eleifend accui Fusce porttitor ex arcu. Phasellus viverra
                  lorem a nibh placerat tincidunt.bolgotai Aliquam andit rutrum
                  elementum urna, vel fringilla tellus varius ut. Morbi non
                  velit odio.
                </p>
