    ...
    <section className="post-gallery-details mt-100">
      <div className="container">
          ...
          <div className="col-12">
            <div className="post-gallery-thumb mb-70">
              <div className="blog-slider-wrapper">
                <div
                  className="blog-stand-next swiper-next-arrow"
                  tabIndex={0}
                  role="button"
                ...
                <div
                  className="blog-stand-prev swiper-prev-arrow"
                  tabIndex={0}
                  role="button"
                ...
                <Swiper {...slider} className="swiper post-gallery-card-slider">
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/images/post-gallery-format/post-gallery-banner-img.jpg"
                        alt="image"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/images/post-gallery-format/post-gallery-banner-img2.jpg"
                        alt="image"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/images/post-gallery-format/post-gallery-banner-img3.jpg"
                        alt="image"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/images/post-gallery-format/post-gallery-banner-img4.jpg"
                        alt="image"
                      />
                    </SwiperSlide>
                  </div>
        ...
        <div className="post-gallery-title">
          ...
          <h2>
            Our Begin Now To Beingonl What Yourmoi Will Be own fully gone.
          </h2>
        </div>
              ...
              <div className="row g-4">
                <div className="col-lg-4 col-md-4 col-sm-4">
                  <div className="post-details-img">
                    <img
                      src="/assets/images/post-gallery-format/post-details-img1.jpg"
                      alt=""
                    />
                  </div>
                </div>
                <div className="col-lg-4 col-md-4 col-sm-4">
                  <div className="post-details-img">
                    <img
                      src="/assets/images/post-gallery-format/post-details-img2.jpg"
                      alt=""
                    />
                  </div>
                </div>
                <div className="col-lg-4 col-md-4 col-sm-4">
                  <div className="post-details-img">
                    <img
                      src="/assets/images/post-gallery-format/post-details-img3.jpg"
                      alt=""
                    />
                  </div>
                </div>
