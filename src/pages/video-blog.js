          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              <div className="video position-relative">
                ...
                <img
                  src="/assets/images/blog-video/blog-video1.jpg"
                  alt="image"
                />
              </div>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/video-post-format">
                    <a>Cras congue est eget nisi lacinia non sagittis.</a>
                  </Link>
                </h4>
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              <div className="video position-relative">
                ...
                <img
                  src="/assets/images/blog-video/blog-video2.jpg"
                  alt="image"
                />
              </div>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/video-post-format">
                    <a>Nam mauris mauris rutum ultricies nonme.</a>
                  </Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/video-post-format">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              <div className="video position-relative">
                ...
                <img
                  src="/assets/images/blog-video/blog-video3.jpg"
                  alt="image"
                />
              </div>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/video-post-format">
                    <a>Proin ultrices lacus sedal convallis placerat.</a>
                  </Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/video-post-format">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              <div className="video position-relative">
                ...
                <img
                  src="/assets/images/blog-video/blog-video4.jpg"
                  alt="image"
                />
              </div>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/video-post-format">
                    <a>Laoreet ligula mauris nec velit. Nullam.</a>
                  </Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/video-post-format">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              <div className="video position-relative">
                ...
                <img
                  src="/assets/images/blog-video/blog-video5.jpg"
                  alt="image"
                />
              </div>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/video-post-format">
                    <a>Consectetur adipi scingoi elitInte rdumet.</a>
                  </Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/video-post-format">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              <div className="video position-relative">
                ...
                <img
                  src="/assets/images/blog-video/blog-video6.jpg"
                  alt="image"
                />
              </div>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/video-post-format">
                    <a>Cras bibendum lacus dict nulla vehicula.</a>
                  </Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/video-post-format">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              <div className="video position-relative">
                ...
                <img
                  src="/assets/images/blog-video/blog-video7.jpg"
                  alt="image"
                />
              </div>
              <div className="content">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              <div className="video position-relative">
                ...
                <img
                  src="/assets/images/blog-video/blog-video8.jpg"
                  alt="image"
                />
              </div>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/video-post-format">
                    <a>vestibulum Mecenas utot congue lectus.</a>
                  </Link>
                </h4>
                <div className="bottom-area">
                  <Link legacyBehavior href="/video-post-format">
          ...
          <div className="col">
            <div className="blog-video-2 style-2">
              <div className="video position-relative">
                ...
                <img
                  src="/assets/images/blog-video/blog-video9.jpg"
                  alt="image"
                />
              </div>
              <div className="content">
