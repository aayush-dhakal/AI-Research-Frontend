              ...
              <div className="col-md-6">
                <div className="blog-grid-1">
                  ...
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/blog-grid/blog-classic-1.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>est eget nisi lacinia none sagittis mauris.</a>
                      </Link>
                    </h4>
              ...
              <div className="col-md-6">
                <div className="blog-grid-1">
                  ...
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/blog-grid/blog-classic-2.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    <ul>
                      ...
                      <li>
                        <Link legacyBehavior href="/blog-standar">
                          <a>Dec 23, 2022</a>
                        </Link>
                      </li>
                      <li>1.9k View</li>
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-0">
                        <a>ultricies non mi eget mau egestas rutrum.</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
              ...
              <div className="col-md-6">
                <div className="blog-grid-1">
                  ...
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/blog-grid/blog-classic-3.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
              ...
              <div className="col-md-6">
                <div className="blog-grid-1">
                  ...
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/blog-grid/blog-classic-4.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>Proin ultrices, lacus seda tincidunt risus.</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
              ...
              <div className="col-md-6">
                <div className="blog-grid-1">
                  ...
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/blog-grid/blog-classic-5.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>Laoreet ligula mauris nec eros pretium.</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
              ...
              <div className="col-md-6">
                <div className="blog-grid-1">
                  ...
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/blog-grid/blog-classic-6.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>Cras bibendum lacus ant nulla vehicula.</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
              ...
              <div className="col-md-6">
                <div className="blog-grid-1">
                  ...
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/blog-grid/blog-classic-7.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>euismod vitae sapien act ultricies egestas.</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
              ...
              <div className="col-md-6">
                <div className="blog-grid-1">
                  ...
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/blog-grid/blog-classic-8.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>vestbulum Maecenas uto congue lectus.</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
              ...
              <div className="col-md-6">
                <div className="blog-grid-1">
                  ...
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/blog-grid/blog-classic-9.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>auctor massa vellat molls Vestibulum lacinia</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
              ...
              <div className="col-md-6">
                <div className="blog-grid-1">
                  ...
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/blog-grid/blog-classic-10.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>Maximus vehicula tellusa Etiam varius felis.</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
