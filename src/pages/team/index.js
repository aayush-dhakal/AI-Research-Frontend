            ...
            <div className="author-1">
              <div className="author-front">
                ...
                <Link legacyBehavior href="/author-details">
                  <a className="image">
                    <img
                      src="/assets/images/authors/author1-7.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
            ...
            <div className="author-1">
              <div className="author-front">
                ...
                <Link legacyBehavior href="/author-details">
                  <a className="image">
                    <img
                      src="/assets/images/authors/author1-8.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
            ...
            <div className="author-1">
              <div className="author-front">
                ...
                <Link legacyBehavior href="/author-details">
                  <a className="image">
                    <img
                      src="/assets/images/authors/author1-9.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
            ...
            <div className="author-1">
              <div className="author-front">
                ...
                <Link legacyBehavior href="/author-details">
                  <a className="image">
                    <img
                      src="/assets/images/authors/author1-10.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
            ...
            <div className="author-1">
              <div className="author-front">
                ...
                <Link legacyBehavior href="/author-details">
                  <a className="image">
                    <img
                      src="/assets/images/authors/author1-11.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
            ...
            <div className="author-1">
              <div className="author-front">
                ...
                <Link legacyBehavior href="/author-details">
                  <a className="image">
                    <img
                      src="/assets/images/authors/author1-12.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
            ...
            <div className="author-1">
              <div className="author-front">
                ...
                <Link legacyBehavior href="/author-details">
                  <a className="image">
                    <img
                      src="/assets/images/authors/author1-13.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
            ...
            <div className="author-1">
              <div className="author-front">
                ...
                <Link legacyBehavior href="/author-details">
                  <a className="image">
                    <img
                      src="/assets/images/authors/author1-14.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
            ...
            <div className="author-1">
              <div className="author-front">
                ...
                <Link legacyBehavior href="/author-details">
                  <a className="image">
                    <img
                      src="/assets/images/authors/author1-15.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
