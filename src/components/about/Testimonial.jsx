          ...
          <div className="row align-items-center mb-40">
            ...
            <div className="col-lg-3 d-flex justify-content-end">
              <div className="slider-arrows arrow-style-1 text-center d-lg-flex d-none flex-row justify-content-center align-items-center gap-4">
                <div
                  className="testimonial-prev swiper-next-arrow"
                  tabIndex={0}
                  role="button"
                ...
                <div
                  className="testimonial-next swiper-prev-arrow"
                  tabIndex={0}
                  role="button"
                ...
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="testimonial-card">
                      <div className="testimonial-card-img">
                        <img
                          src="/assets/images/about/testimonial-card-img1.jpg"
                          alt=""
                        />
                      </div>
                      <div className="testimonial-card-content">
                        <p>
                          ...
                          tolda exceei my expectations with his quality work and
                          fastestopa service, veryal smooth and simple
                          communication."
                        </p>
                        ...
                        <div className="testimonial-card-quotes">
                          <img
                            src="/assets/images/about/testimonial-quotes.svg"
                            alt=""
                          />
                        </div>
                      </div>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="testimonial-card">
                      <div className="testimonial-card-img">
                        <img
                          src="/assets/images/about/testimonial-card-img2.jpg"
                          alt=""
                        />
                      </div>
                      <div className="testimonial-card-content">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="testimonial-card">
                      <div className="testimonial-card-img">
                        <img
                          src="/assets/images/about/testimonial-card-img3.jpg"
                          alt=""
                        />
                      </div>
                      <div className="testimonial-card-content">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="testimonial-card">
                      <div className="testimonial-card-img">
                        <img
                          src="/assets/images/about/testimonial-card-img4.jpg"
                          alt=""
                        />
                      </div>
                      <div className="testimonial-card-content">
