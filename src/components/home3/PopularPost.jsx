          ...
          <div className="col-lg-8">
            <div className="blog-list-4 mb-30">
              <Link legacyBehavior href="/post-format-no-sidebar-02">
                <a className="image">
                  <img
                    src="assets/images/blog-list/popular-1.jpg"
                    alt="image"
                  />
                </a>
              </Link>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a>
                      Phasellus porttitor exten vitae felis finibus at rhoncus
                      mauris..
                    </a>
                  </Link>
                </h4>
            ...
            <div className="blog-list-4 mb-30">
              <Link legacyBehavior href="/post-format-no-sidebar-02">
                <a className="image">
                  <img
                    src="assets/images/blog-list/popular-2.jpg"
                    alt="image"
                  />
                </a>
              </Link>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a>
                      Quisque scelon sque egestas nunc sed interdum Pellente.
                    </a>
                  </Link>
                </h4>
              </div>
            ...
            <div className="blog-list-4 mb-30">
              <Link legacyBehavior href="/post-format-no-sidebar-02">
                <a className="image">
                  <img
                    src="assets/images/blog-list/popular-3.jpg"
                    alt="image"
                  />
                </a>
              </Link>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a>
                      porta lacus velga maximus Integer tristique eget lectus.
                    </a>
                  </Link>
                </h4>
              </div>
            ...
            <div className="blog-list-4 mb-30">
              <Link legacyBehavior href="/post-format-no-sidebar-02">
                <a className="image">
                  <img
                    src="assets/images/blog-list/popular-4.jpg"
                    alt="image"
                  />
                </a>
              </Link>
              <div className="content">
                ...
                <h4>
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a>
                      vitae euismod fringilla Nam europe lectus quis arcu
                      ornare.
                    </a>
                  </Link>
                </h4>
            ...
            <div className="popular-list-wrapper mb-30">
              ...
              <div className="blog-list-1 style-five">
                <Link legacyBehavior href="/post-format-no-sidebar-02">
                  <a className="image">
                    <img
                      src="assets/images/blog-list/popular-list1.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
                <div className="content">
                  <h6>
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a>
                        gravida orci sed jaritob laorei tellus furthure gone.
                      </a>
                    </Link>
                  </h6>
                  <ul>
              ...
              <div className="blog-list-1 style-five">
                <Link legacyBehavior href="/post-format-no-sidebar-02">
                  <a className="image">
                    <img
                      src="assets/images/blog-list/popular-list2.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
              ...
              <div className="blog-list-1 style-five">
                <Link legacyBehavior href="/post-format-no-sidebar-02">
                  <a className="image">
                    <img
                      src="assets/images/blog-list/popular-list3.jpg"
                      alt="image"
                    />
                  </a>
                </Link>
                <div className="content">
                  <h6>
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a>
                        pulvinar facilisis Sed dapibusot turpis vitae felis.
                      </a>
                    </Link>
                  </h6>
                  <ul>
