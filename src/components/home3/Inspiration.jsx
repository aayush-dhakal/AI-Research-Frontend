              ...
              >
                <div className="row gy-3">
                  <div className="col-xl-8 col-lg-7">
                    <div
                      className="blog-image-3 mb-30"
                      style={{
                        background:
                          'linear-gradient(rgba(23, 23, 23,0.6),rgba(23, 23, 23,0.6)), url("/assets/images/blog-image/inspire-1.jpg")',
                        width: "100%",
                      }}
                    >
                      <div className="content">
                        <h3>
                          ...
                          >
                            <a>
                              Roaming Around the World Around the World in 80
                              Days.
                            </a>
                          </Link>
                        </h3>
                        <ul className="meta">
                          <li>
                            <Link legacyBehavior href="/author-details">
                              <a>
                                <img
                                  src="/assets/images/icons/user-sm.svg"
                                  alt=""
                                />
                                By, Watson Dube
                              </a>
                          ...
                          <li>
                            <Link legacyBehavior href="/blog-standard">
                              <a>
                                <img
                                  src="/assets/images/icons/date-sm.svg"
                                  alt=""
                                />
                                21 Dec, 2022
                              </a>
                          ...
                          <li>
                            <Link legacyBehavior href="/blog-standard">
                              <a>
                                <img
                                  src="/assets/images/icons/comment-sm.svg"
                                  alt=""
                                />
                                450 Comment
                              </a>
                    ...
                    <div className="blog-list-6 mb-30">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a className="image">
                          <img
                            src="/assets/images/blog-list/inspire-2.jpg"
                            alt="image"
                          />
                        </a>
                      </Link>
                      <div className="content">
                        ...
                        <h4>
                          ...
                          >
                            <a>
                              The Best Day Trips from Activity Experience
                              Cultural.
                            </a>
                          </Link>
                        </h4>
                    ...
                    <div className="blog-list-6">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a className="image">
                          <img
                            src="/assets/images/blog-list/inspire-3.jpg"
                            alt="image"
                          />
                        </a>
                      </Link>
                      <div className="content">
                        ...
                        <h4>
                          ...
                          >
                            <a>
                              Riskort Taker's Retreaton Survival Stories andose
                              Escapade.
                            </a>
                          </Link>
                        </h4>
                  ...
                  <div className="col-xl-4 col-lg-5">
                    <div className="blog-img-list">
                      <div
                        className="blog-image-4 mb-30 img-adjust"
                        style={{
                          background:
                            'linear-gradient(rgba(23, 23, 23,0.7),rgba(23, 23, 23,0.7)), url("/assets/images/blog-image/inspire-4.jpg")',
                          width: "100%",
                        }}
                      >
                        <div className="content">
                          ...
                          <h5>
                            ...
                            >
                              <a>
                                5 Ways to Boost Your Blog and tourism Traffic
                                rules.
                              </a>
                            </Link>
                          </h5>
                      ...
                      <div className="blog-list-7">
                        ...
                        <div className="content">
                          ...
                          <h5>
                            ...
                            >
                              <a>
                                vestibulum ligula sodalesoi Morbi iaculis
                                laoreet.
                              </a>
                            </Link>
                          </h5>
                        ...
                        <div className="content">
                          ...
                          <h5>
                            <Link
                              ...
                              href="/post-format-no-sidebar-02"
                            >
                              <a>That Adventurer's Journal Nature's Nomad.</a>
                            </Link>
                          </h5>
                        </div>
                      </div>
                        ...
                        <div className="content">
                          ...
                          <h5>
                            <Link
                              ...
                              href="/post-format-no-sidebar-02"
                            >
                              <a>Beyond then Wanderlust Wildern Horizon.</a>
                            </Link>
                          </h5>
                        </div>
                      </div>
                        ...
                        <div className="content">
                          ...
                          <h5>
                            <Link
                              ...
                              href="/post-format-no-sidebar-02"
                            >
                              <a>The Importance Blogging Quality Content. </a>
                            </Link>
                          </h5>
                        </div>
                      </div>
                        ...
                        <div className="content">
                          ...
                          <h5>
                            <Link
                              ...
                              href="/post-format-no-sidebar-02"
                            >
                              <a>The Role of Social Media travel Blogging.</a>
                            </Link>
                          </h5>
                        </div>
                      </div>
