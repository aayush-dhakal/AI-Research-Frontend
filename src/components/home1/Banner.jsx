      ...
      <div className="container-fluid">
        <div className="row justify-content-center">
                  ...
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-grid-3">
                        <Link legacyBehavior href="/blog-classic">
                          <a className="eg-badge badge--red">Life Style</a>
                        </Link>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-grid-3">
                        <Link legacyBehavior href="/author-details">
                          <a className="author">
                            <img
                              src="/assets/images/authors/author1-2.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <Link legacyBehavior href="/blog-classic">
                          <a className="eg-badge badge--red">Creative</a>
                        </Link>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a className="image">
                            <img
                        ...
                        <div className="content">
                          ...
                          <h4>
                            ...
                            >
                              <a>
                                Unleash Your Creativity: Explore the World of
                                Creative Works.
                              </a>
                            </Link>
                          </h4>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-grid-3">
                        <Link legacyBehavior href="/author-details">
                          <a className="author">
                            <img
                              src="/assets/images/authors/author1-3.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <Link legacyBehavior href="/blog-classic">
                          <a className="eg-badge badge--red">Golf Club</a>
                        </Link>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a className="image">
                            <img
                        ...
                        <div className="content">
                          ...
                          <h4>
                            ...
                            >
                              <a>
                                Hit the Green: Explore Our Golf Club's Amazing
                                Offerings.
                              </a>
                            </Link>
                          </h4>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-grid-3">
                        <Link legacyBehavior href="/author-details">
                          <a className="author">
                            <img
                              src="/assets/images/authors/author2-4.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <Link legacyBehavior href="/blog-classic">
                          <a className="eg-badge badge--red">Art</a>
                        </Link>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a className="image">
                            <img
                              src="/assets/images/banner/banner1-4.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <div className="content">
                          ...
                          <h4>
                            <Link
                              ...
                              href="/post-format-no-sidebar-02"
                            >
                              <a>Brushstrokes of Creativity: Art in Motion.</a>
                            </Link>
                          </h4>
                          <div className="bottom-area">
                            <Link
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-grid-3">
                        <Link legacyBehavior href="/author-details">
                          <a className="author">
                            <img
                              src="/assets/images/authors/author2-1.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <Link legacyBehavior href="/blog-classic">
                          <a className="eg-badge badge--red">Interior</a>
                        </Link>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a className="image">
                            <img
                              src="/assets/images/banner/banner1-5.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <div className="content">
                          ...
                          <h4>
                            ...
                            >
                              <a>
                                Discover the Art of Interior Decoration and
                                Styling.
                              </a>
                            </Link>
                          </h4>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-grid-3">
                        <Link legacyBehavior href="/author-details">
                          <a className="author">
                            <img
                              src="/assets/images/authors/author2-2.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <Link legacyBehavior href="/blog-classic">
                          <a className="eg-badge badge--red">Foodest</a>
                        </Link>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a className="image">
                            <img
                              src="/assets/images/banner/banner1-11.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <div className="content">
                          ...
                          <h4>
                            ...
                            >
                              <a>
                                Foodie's Paradise: Indulge in Exquisite Cuisine.
                              </a>
                            </Link>
                          </h4>
                          <div className="bottom-area">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-grid-3">
                        ...
                        <Link legacyBehavior href="/blog-classic">
                          <a className="eg-badge badge--red">Sports</a>
                        </Link>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a className="image">
                            <img
                              src="/assets/images/banner/banner1-12.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <div className="content">
                          ...
                          <h4>
                            ...
                            >
                              <a>
                                Elevate Your Game: The Ultimate Sports
                                Experience.
                              </a>
                            </Link>
                          </h4>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-grid-3">
                        <Link legacyBehavior href="/author-details">
                          <a className="author">
                            <img
                              src="/assets/images/authors/author1-4.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <Link legacyBehavior href="/blog-classic">
                          <a className="eg-badge badge--red">Travel</a>
                        </Link>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a className="image">
                            <img
                              src="/assets/images/banner/banner1-13.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                        <div className="content">
                          ...
                          <h4>
                            ...
                            >
                              <a>
                                Explore the World: Unforgettable Travel
                                Destinations.
                              </a>
                            </Link>
                          </h4>
                      ...
                      <div className="blog-grid-3">
                        ...
                        <div className="content">
                          ...
                          <h4>
                            ...
                            >
                              <a>
                                imperdiet ident turpis Nuncon ont scelerisque
                                ante.
                              </a>
                            </Link>
                          </h4>
                      ...
                      <div className="blog-grid-3">
                        ...
                        <div className="content">
                          ...
                          <h4>
                            ...
                            >
                              <a>
                                hendrerit condimentum orcho id porta lobortis
                                nibh.
                              </a>
                            </Link>
                          </h4>
                        ...
                        <div className="content">
                          ...
                          <h4>
                            <Link
                              ...
                              href="/post-format-no-sidebar-02"
                            >
                              <a>eleifend consectetu ante quam Nam quis.</a>
                            </Link>
                          </h4>
                          <div className="bottom-area">
                            <Link
                        ...
                        <div className="content">
                          ...
                          <h4>
                            <Link
                              ...
                              href="/post-format-no-sidebar-02"
                            >
                              <a>ullamcorper dolor Proinol augue dolor..</a>
                            </Link>
                          </h4>
                          <div className="bottom-area">
                            <Link
          ...
          <div className="col-12 text-center d-flex align-items-center justify-content-center gap-5">
            <div
              className="banner1-prev swiper-prev-arrow"
              tabIndex={0}
              role="button"
            ...
            <ul
              className="nav nav-tabs nav-style-1 justify-content-center"
              role="tablist"
            >
            ...
            <div
              className="banner1-next swiper-next-arrow"
              tabIndex={0}
              role="button"
