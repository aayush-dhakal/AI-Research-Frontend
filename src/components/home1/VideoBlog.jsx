          ...
          <div className="row align-items-center g-4 mb-40">
            ...
            <div className="col-md-3 d-flex justify-content-md-end">
              <Link legacyBehavior href="/video-blog">
                <a className=" eg-btn arrow-btn-2">
                  Explore All
            ...
            <div className="col-lg-7">
              <div className="blog-video-1">
                <div className="video position-relative">
                  ...
                  <img
                    src="/assets/images/blog-video/video1-1.jpg"
                    alt="image"
                  />
                </div>
                <div className="content">
                  ...
                  <h3>
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a>
                        Our Begin Now To Beingonl What Your Will Be own fully
                        gone..
                      </a>
                    </Link>
                  </h3>
                  <p>
                    ...
                    fermentumon odiona gouvikoi tincidunt vel. Proin velit est,
                    elementum sed hendrerit quisesa mattis at nisol. Morbus
                    condimentum massa id tellus fringilla.
                  </p>
                  <div className="video-author">
                    <Link legacyBehavior href="/author-details">
                      <a>By Vigola Morgan</a>
                    </Link>
                    <Link legacyBehavior href="/blog-standard">
              ...
              <div className="video-sidebar">
                <div className="blog-video-2">
                  <div className="video position-relative">
                    ...
                    <img
                      src="/assets/images/blog-video/video2-1.jpg"
                      alt="image"
                    />
                  </div>
                  <div className="content">
                    ...
                    <h3>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>Nunc scelerisque ante oltaga consequat elementum.</a>
                      </Link>
                    </h3>
                  </div>
                ...
                <div className="blog-video-2">
                  <div className="video position-relative">
                    ...
                    <img
                      src="/assets/images/blog-video/video2-2.jpg"
                      alt="image"
                    />
                  </div>
                  <div className="content">
                    ...
                    <h3>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>
                          Sed lectus duitotan tristiquei eleifend blandit nec.
                        </a>
                      </Link>
                    </h3>
                  </div>
          ...
          <div className="row">
            <ul className="menu__item-container">
              <li className="menu__item">
                <div className="blog-grid-2 menu__item-text">
                  <div className="content">
                    <ul>
                      <li>
                        <Link legacyBehavior href="/author-details">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>maximus urna nec estrango ligula sodales.</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                ...
                <div className="menu__item-image living">
                  {/* <img class="img-fluid" src="/assets/images/blog-grid/grid3-1.jpg" alt=""> */}
                </div>
              </li>
              <li className="menu__item">
                <div className="blog-grid-2 menu__item-text">
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>luctus et ultrices posue ret cubilia curaen..</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                ...
                <div className="menu__item-image dining" />
              </li>
              <li className="menu__item">
                <div className="blog-grid-2 menu__item-text">
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>
                          Nulla Gotem sem imperdiett eget elitat sollicitudin.
                        </a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                ...
                <div className="menu__item-image endulging" />
              </li>
            </ul>
          </div>
        </div>
