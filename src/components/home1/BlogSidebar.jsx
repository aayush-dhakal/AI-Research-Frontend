                ...
                <SwiperSlide className="swiper-slide">
                  ...
                  <div className="blog-list-2">
                    ...
                    <div className="content">
                      ...
                      <h4>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a>Our Begin Now To Beingonl What You Will Be.</a>
                        </Link>
                      </h4>
                    ...
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a className="image">
                        <img
                          src="/assets/images/blog-list/blog-list2-1.jpg"
                          alt=""
                        />
                      </a>
                    </Link>
                  ...
                  <div className="blog-list-2">
                    ...
                    <div className="content">
                      ...
                      <h4>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a>
                            primis in faucibusori cubilia luctus et ultrices
                          </a>
                        </Link>
                      </h4>
                      <div className="bottom-area">
                    ...
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a className="image">
                        <img
                          src="/assets/images/blog-list/blog-list2-2.jpg"
                          alt=""
                        />
                      </a>
                    </Link>
                  ...
                  <div className="blog-list-2">
                    ...
                    <div className="content">
                      ...
                      <h4>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a>
                            vestibulum ligula sodalesoi Morbi iaculis laoreet.
                          </a>
                        </Link>
                      </h4>
                      <div className="bottom-area">
                    ...
                    <div className="image">
                      <div className="video position-relative">
                        ...
                        <img
                          src="/assets/images/blog-list/blog-list2-3.jpg"
                          alt="image"
                        />
                      </div>
                    </div>
                  ...
                  <div className="blog-list-2">
                    ...
                    <div className="content">
                      ...
                      <h4>
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                          <a>Etiam et quam atentl tortor placerat facilisis.</a>
                        </Link>
                      </h4>
                      <div className="bottom-area">
                        <Link legacyBehavior href="/post-format-no-sidebar-02">
                    ...
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a className="image">
                        <img
                          src="/assets/images/blog-list/blog-list2-4.jpg"
                          alt=""
                        />
                      </a>
                    </Link>
