      ...
      <div className="row mb-40">
        ...
        <div className="col-sm-4">
          <div className="slider-arrows arrow-style-3 text-center d-flex flex-row justify-content-end align-items-center gap-2">
            <div
              className="selected-next swiper-next-arrow"
              tabIndex={0}
              role="button"
            ...
            <div
              className="selected-prev swiper-prev-arrow"
              tabIndex={0}
              role="button"
                ...
                <div className="blog-grid-5 style-2">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      ...
                      <img
                        src="/assets/images/blog-grid/select-post1.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                ...
                <div className="blog-grid-5 style-2">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      ...
                      <img
                        src="/assets/images/blog-grid/select-post2.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>
                          Mauris placerat dolor nec seman porttitor suscipit.
                        </a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                ...
                <div className="blog-grid-5 style-2">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      ...
                      <img
                        src="/assets/images/blog-grid/select-post3.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>per inceptos himenaeos malesua Vivamus portaip</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                ...
                <div className="blog-grid-5 style-2">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      ...
                      <img
                        src="/assets/images/blog-grid/select-post4.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>
                          Integer convallis nisagoi necerat fermentum vehicula.
                        </a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                ...
                <div className="blog-grid-5 style-2">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      ...
                      <img
                        src="/assets/images/blog-grid/select-post5.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                ...
                <div className="blog-grid-5 style-2">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      ...
                      <img
                        src="/assets/images/blog-grid/select-post6.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
                ...
                <div className="blog-grid-5 style-2">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      ...
                      <img
                        src="/assets/images/blog-grid/select-post7.jpg"
                        alt="image"
                      />
                    </a>
                  </Link>
