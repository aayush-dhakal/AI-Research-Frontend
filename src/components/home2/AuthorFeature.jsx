                    ...
                    <div className="author-2">
                      <div className="image-area">
                        <Link legacyBehavior href="/author-details">
                          <a>
                            <img
                              src="/assets/images/authors/author2-3.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="author-2">
                      <div className="image-area">
                        <Link legacyBehavior href="/author-details">
                          <a>
                            <img
                              src="/assets/images/authors/author2-5.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="author-2">
                      <div className="image-area">
                        <Link legacyBehavior href="/author-details">
                          <a>
                            <img
                              src="/assets/images/authors/author2-6.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="author-2">
                      <div className="image-area">
                        <Link legacyBehavior href="/author-details">
                          <a>
                            <img
                              src="/assets/images/authors/author2-7.jpg"
                              alt="image"
                            />
                          </a>
                        </Link>
