    ...
    const generateProgressBars = () => {
      ...
      for (let i = 0; i < settings.slidesToShow; i++) {
        const progressBar = (
          <div
            key={`progressBar${i}`}
            className={`inProgress inProgress${i}`}
          />
        );
                      ...
                      <div className="popular-post one">
                        ...
                        <div className="post-title">
                          <h5>
                            ...
                            >
                              <a>
                                Praesent rutrum dignissi meote tristique Sed
                                hendrer.
                              </a>
                            </Link>
                          </h5>
                      ...
                      <div className="popular-post">
                        ...
                        <div className="post-title">
                          <h5>
                            ...
                            >
                              <a>
                                eget blandi vitae aliqua tesquon molestie eros
                                Pellen.
                              </a>
                            </Link>
                          </h5>
                      ...
                      <div className="popular-post">
                        ...
                        <div className="post-title">
                          <h5>
                            ...
                            >
                              <a>
                                mollis fermentum elemen tumdut Pellent esque
                                aliquam.
                              </a>
                            </Link>
                          </h5>
                      ...
                      <div className="popular-post">
                        ...
                        <div className="post-title">
                          <h5>
                            ...
                            >
                              <a>
                                Aliquam erat volutpat Crasid blat auctor
                                pulvinar nulla.
                              </a>
                            </Link>
                          </h5>
                      ...
                      <div className="popular-post">
                        ...
                        <div className="post-title">
                          <h5>
                            ...
                            >
                              <a>
                                sollicitudin acbiben dume avitae cursus eudui
                                Praesent
                              </a>
                            </Link>
                          </h5>
                      ...
                      <div className="popular-post">
                        ...
                        <div className="post-title">
                          <h5>
                            ...
                            >
                              <a>
                                Aliquam eraton volutpat Crastont auctor pulvinar
                                nulla.
                              </a>
                            </Link>
                          </h5>
                  ...
                  <Slider {...settings} className="slider single-item">
                    <div className="slider-item">
                      <div className="popular-post-card">
                        <div className="post-img">
                          <img
                            src="/assets/images/blog-grid/popular-2-1.png"
                            alt=""
                          />
                        ...
                        <div className="post-content">
                          ...
                          <p>
                            Aliquam erat volutpat Ut scelerisque element umet
                            nisi a fermentumon odiona gouvikoi tincidunt velgo
                            Proin velit est elementum sed.
                          </p>
                    ...
                    <div className="slider-item">
                      <div className="popular-post-card">
                        <div className="post-img">
                          <img
                            src="/assets/images/blog-grid/popular-2-2.png"
                            alt=""
                          />
                          <div className="category">
                            <Link legacyBehavior href="/blog-classic">
                    ...
                    <div className="slider-item">
                      <div className="popular-post-card">
                        <div className="post-img">
                          <img
                            src="/assets/images/blog-grid/popular-2-3.png"
                            alt=""
                          />
                          <div className="category">
                            <Link legacyBehavior href="/blog-classic">
                    ...
                    <div className="slider-item">
                      <div className="popular-post-card">
                        <div className="post-img">
                          <img
                            src="/assets/images/blog-grid/popular-2-4.png"
                            alt=""
                          />
                          <div className="category">
                            <Link legacyBehavior href="/blog-classic">
                    ...
                    <div className="slider-item">
                      <div className="popular-post-card">
                        <div className="post-img">
                          <img
                            src="/assets/images/blog-grid/popular-2-5.png"
                            alt=""
                          />
                          <div className="category">
                            <Link legacyBehavior href="/blog-classic">
