            ...
            <div className="row justify-content-center g-4">
              <div className="col-md-6 col-sm-10">
                <div className="blog-grid-1 three">
                  <div className="image">
                    <img
                      src="/assets/images//blog-grid/blog-grid2-1.png"
                      alt="image"
                    />
                  ...
                  <div className="content">
                    <h5>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>magna erat viverra eget convan molestie sit amet.</a>
                      </Link>
                    </h5>
              ...
              <div className="col-md-6 col-sm-10">
                <div className="blog-grid-1 three">
                  <div className="image">
                    <img
                      src="/assets/images//blog-grid/blog-grid2-2.png"
                      alt="image"
                    />
                    <div className="category">
                      <Link legacyBehavior href="/blog-classic">
                  ...
                  <div className="content">
                    <h5>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>tortor non lacinia nunc Donecn id tempor sapien.</a>
                      </Link>
                    </h5>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/blog-standard">
              ...
              <div className="col-md-6 col-sm-10">
                <div className="blog-grid-1 three">
                  <div className="image">
                    <img
                      src="/assets/images//blog-grid/blog-grid2-3.png"
                      alt="image"
                    />
                    <div className="category">
                      <Link legacyBehavior href="/blog-classic">
                  ...
                  <div className="content">
                    <h5>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>consectetur adipiscing elitNamt sed mauris urna.</a>
                      </Link>
                    </h5>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/blog-standard">
              ...
              <div className="col-md-6 col-sm-10">
                <div className="blog-grid-1 three">
                  <div className="image">
                    <img
                      src="/assets/images//blog-grid/blog-grid2-4.png"
                      alt="image"
                    />
                    <div className="category">
                      <Link legacyBehavior href="/blog-classic">
                  ...
                  <div className="content">
                    <h5>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>
                          interdum tortor non lacini andi nunc Donec tempor.
                        </a>
                      </Link>
                    </h5>
                    <div className="bottom-area">
            ...
            <div className="article-post-area">
              ...
              <div className="recent-list-1 mb-25">
                <Link legacyBehavior href="/post-format-no-sidebar-02">
                  <a className="image">
                    <img
                      src="/assets/images/latest-post/latest-post2-1.png"
                      alt="image"
                    />
                  </a>
                </Link>
              ...
              <div className="recent-list-1 mb-25">
                ...
                <div className="content">
                  <h6>
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a>molestie commod Duvt Vivamus pretium.</a>
                    </Link>
                  </h6>
                  <ul>
                    <li>
              ...
              <div className="recent-list-1 mb-25">
                <Link legacyBehavior href="post-format-no-sidebar-02">
                  <a className="image">
                    <img
                      src="/assets/images/latest-post/latest-post2-3.png"
                      alt="image"
                    />
                  </a>
                </Link>
                <div className="content">
                  <h6>
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a>Nullam elementum eros non urna gravida.</a>
                    </Link>
                  </h6>
                  <ul>
                    <li>
              ...
              <div className="recent-list-1 mb-25">
                <Link legacyBehavior href="/post-format-no-sidebar-02">
                  <a className="image">
                    <img
                      src="/assets/images/latest-post/latest-post2-4.png"
                      alt="image"
                    />
                  </a>
                </Link>
                <div className="content">
                  <h6>
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a>Donec at sagittis enmy Integer vitae nulla.</a>
                    </Link>
                  </h6>
                  <ul>
                    <li>
              ...
              <div className="recent-list-1 mb-25">
                <Link legacyBehavior href="/post-format-no-sidebar-02">
                  <a className="image">
                    <img
                      src="/assets/images/latest-post/latest-post2-5.png"
                      alt="image"
                    />
                  </a>
                </Link>
                <div className="content">
                  <h6>
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a>faucibus libero turpist nec tincidunt.</a>
                    </Link>
                  </h6>
                  <ul>
                    <li>
              ...
              <div className="recent-list-1">
                <Link legacyBehavior href="/post-format-no-sidebar-02">
                  <a className="image">
                    <img
                      src="/assets/images/latest-post/latest-post2-6.png"
                      alt="image"
                    />
                  </a>
                </Link>
                <div className="content">
                  <h6>
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a>consectetur adipiscino Vivamus tempor.</a>
                    </Link>
                  </h6>
                  <ul>
                    <li>
