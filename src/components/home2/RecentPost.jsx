              ...
              <div className="col-md-6 col-sm-6">
                <div className="blog-grid-1 two">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/recent-post/recent2-1.png"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>
                          Nulla Gotem sem imperdie foret eget elitat
                          sollicitudin.
                        </a>
                      </Link>
                    </h4>
              ...
              <div className="col-md-6 col-sm-6">
                <div className="blog-grid-1 two">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/recent-post/recent2-2.png"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>Maecenas ullamcorper urna jusi non enim aliquet.</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
              ...
              <div className="col-md-6 col-sm-6">
                <div className="blog-grid-1 two">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/recent-post/recent2-3.png"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>
                          blandit sit amet diam eu luctus hendrerit. Praesent.
                        </a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
              ...
              <div className="col-md-6 col-sm-6">
                <div className="blog-grid-1 two">
                  <Link legacyBehavior href="/post-format-no-sidebar-02">
                    <a className="image">
                      <img
                        src="/assets/images/recent-post/recent2-4.png"
                        alt="image"
                      />
                    </a>
                  </Link>
                  <div className="content">
                    ...
                    <h4>
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
                        <a>Quisque ipsum diam fringil one non exsit ametpe.</a>
                      </Link>
                    </h4>
                    <div className="bottom-area">
                      <Link legacyBehavior href="/post-format-no-sidebar-02">
          ...
          <div className="col-lg-4">
            ...
            <div className="another-post-area mb-50">
              <div className="recent-list-1 mb-25">
                <div className="image">
                  <img
                    src="/assets/images/blog-list/video-img1.jpg"
                    alt="image"
                  />
              ...
              <div className="recent-list-1 mb-25">
                <div className="image">
                  <img
                    src="/assets/images/blog-list/video-img2.jpg"
                    alt="image"
                  />
                </div>
                <div className="content">
                  <h6>
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a>Vestibulum rhoncus euism Inurna oni consequat.</a>
                    </Link>
                  </h6>
                  <ul>
                    <li>
              ...
              <div className="recent-list-1 p-0">
                <div className="image">
                  <img
                    src="/assets/images/blog-list/video-img3.jpg"
                    alt="image"
                  />
                  <div className="video-play2">
                    <div
                ...
                <div className="content">
                  <h6>
                    <Link legacyBehavior href="/post-format-no-sidebar-02">
                      <a>pulvinar facilisis Sed turpa dapibusot vitae.</a>
                    </Link>
                  </h6>
                  <ul>
                    <li>
