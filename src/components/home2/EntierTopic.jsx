                ...
                <div className="tropic-card">
                  <div className="tropic-img">
                    <Link legacyBehavior href="/blog-classic">
                      <a>
                        <img src="/assets/images/category/cat2-1.png" alt="" />
                      </a>
                    </Link>
                  </div>
                  <div className="tropic-content">
                    <Link legacyBehavior href="/blog-classic">
                      <a className="tropic-icon">
                        <img
                          src="/assets/images/icons/creative-02.svg"
                          alt=""
                        />
                      </a>
                    </Link>
              ...
              <SwiperSlide className="swiper-slide">
                <div className="tropic-card">
                  <div className="tropic-img">
                    <Link legacyBehavior href="/blog-classic">
                      <a>
                        <img src="/assets/images/category/cat2-2.png" alt="" />
                      </a>
                    </Link>
                  </div>
                  <div className="tropic-content">
                    <Link legacyBehavior href="/blog-classic">
                      <a className="tropic-icon">
                        <img
                          src="/assets/images/icons/lifestyle-02.svg"
                          alt=""
                        />
                      </a>
                    </Link>
              ...
              <SwiperSlide className="swiper-slide">
                <div className="tropic-card">
                  <div className="tropic-img">
                    <Link legacyBehavior href="/blog-classic">
                      <a>
                        <img src="/assets/images/category/cat2-3.png" alt="" />
                      </a>
                    </Link>
                  </div>
                  <div className="tropic-content">
              ...
              <SwiperSlide className="swiper-slide">
                <div className="tropic-card">
                  <div className="tropic-img">
                    <Link legacyBehavior href="/blog-classic">
                      <a>
                        <img src="/assets/images/category/cat2-4.png" alt="" />
                      </a>
                    </Link>
                  </div>
                  <div className="tropic-content">
              ...
              <SwiperSlide className="swiper-slide">
                <div className="tropic-card">
                  <div className="tropic-img">
                    <Link legacyBehavior href="/blog-classic">
                      <a>
                        <img src="/assets/images/category/cat2-5.png" alt="" />
                      </a>
                    </Link>
                  </div>
                  <div className="tropic-content">
              ...
              <SwiperSlide className="swiper-slide">
                <div className="tropic-card">
                  <div className="tropic-img">
                    <Link legacyBehavior href="/blog-classic">
                      <a>
                        <img src="/assets/images/category/cat2-6.png" alt="" />
                      </a>
                    </Link>
                  </div>
                  <div className="tropic-content">
              ...
              <SwiperSlide className="swiper-slide">
                <div className="tropic-card">
                  <div className="tropic-img">
                    <Link legacyBehavior href="/blog-classic">
                      <a>
                        <img src="/assets/images/category/cat2-7.png" alt="" />
                      </a>
                    </Link>
                  </div>
                  <div className="tropic-content">
