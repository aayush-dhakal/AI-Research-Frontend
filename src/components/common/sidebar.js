            ...
            <Link legacyBehavior href="/">
              <a>
                <img
                  alt="image"
                  className="img-fluid"
                  src="/assets/images/logo/logo-6.svg"
                />
              </a>
            </Link>
          </div>
        ...
        <div className="sidebar-menu-area">
          <ul className="menu-list">
            <li className="menu-item-has-children menu-item ">
              ...
              <i
                className="bi bi-plus dropdown-icon2"
            ...
            <li className="menu-item">
              <Link legacyBehavior href="/topic" data-hover="Topic">
                <a>Topic</a>
              </Link>
            </li>
            <li className="menu-item-has-children menu-item">
              <Link legacyBehavior href="/blog-column-three" data-hover="Post">
                <a>Post</a>
              </Link>
              <i
                onClick={() => handleMenu("post-formate")}
                className="bi bi-plus dropdown-icon2"
              />
              <ul
                className={
              ...
              >
                <li>
                  ...
                  <i className="bi bi-plus dropdown-icon2" />
                  <ul className="sub-menu">
                    ...
                    <li>
                      <Link legacyBehavior href="/post-format-no-sidebar-03">
                        <a>Post Format 03</a>
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link legacyBehavior href="/post-format-no-sidebar-05">
                        <a>Post Format 05</a>
                      </Link>
                    </li>
                  </ul>
                ...
                <li>
                  <a href="#">Post Format Sidebar</a>
                  <i className="bi bi-plus dropdown-icon2" />
                  <ul className="sub-menu">
                    <li>
                      <Link legacyBehavior href="/post-format-right-sidebar-01">
                        <a>Post Format Right Sidebar 01</a>
                      </Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="/post-format-right-sidebar-02">
                        <a>Post Format Right Sidebar 02</a>
                      </Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="/post-format-right-sidebar-03">
                        <a>Post Format Right Sidebar 03</a>
                      </Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="/post-format-left-sidebar-01">
                        <a>Post Format Left Sidebar 01</a>
                      </Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="/post-format-left-sidebar-02">
                        <a>Post Format Left Sidebar 02</a>
                      </Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="/post-format-left-sidebar-03">
            ...
            <li className="menu-item-has-children menu-item">
              <Link legacyBehavior href="/blog-classic" data-hover="Blog">
                <a>Blog</a>
              </Link>
              <i
                className="bi bi-plus dropdown-icon2"
            ...
            <li className="menu-item">
              <Link legacyBehavior href="/contact" data-hover="Contact">
                <a>Contact</a>
              </Link>
            </li>
          </ul>
